    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if on_surf.collidepoint(event.pos):
                ...
                if bot.side == 'w' and white_first_move: # first move should make by the bot when it plays white
                    bots_move = bot.ramdomly_move(playing_board)
                    print(bots_move)
                    update_move(bots_move)
                ...
                if bot_status == 'ON' and white_first_move: # first move should make by the bot when it plays white
                    bots_move = bot.ramdomly_move(playing_board)
                    print(bots_move)
                    update_move(bots_move)
                    white_first_move = None
